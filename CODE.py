...
class Content(ABC):
    """Абстрактный базовый класс для любого контента в социальной сети."""
...
# ПОЛЬЗОВАТЕЛЬ
class User:
    """Класс Пользователя. Реализует принцип инкапсуляции."""
...
class SocialNetwork:
    """Класс-менеджер социальной сети."""
